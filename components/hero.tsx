    ...
    <div className="pb-28 pt-20 md:pt-40">
      ...
      <div className="relative z-10 px-4 md:px-0">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div 
            ref={containerRef}
            className="hidden md:block group relative aspect-square w-full overflow-hidden rounded-3xl lg:justify-self-end border-2 border-[#0B0B14]/20 md:flex-[5] px-12"
            onMouseEnter={() => setIsHovering(true)}
            onMouseLeave={() => {
              setIsHovering(false);
              setIsAdjustingVolume(false);
