      ...
      <div className="flex flex-col items-center max-lg:mt-10">
        ...
        <div className="flex gap-4 relative z-10">
          <a
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-lg bg-[#14A800] hover:bg-[#108000] transition-colors text-white font-medium"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-6 py-3 rounded-lg bg-[#0A66C2] hover:bg-[#004182] transition-colors text-white font-medium"
          >
